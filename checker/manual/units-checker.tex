...
\item[\refqualclass{checker/units/qual/time/instant}{TimePoint}]
...
\item For \code{@Angle}:
  ...
  Radians \refqualclass{checker/units/qual}{rad},
  and the derived unit

  Degrees \refqualclass{checker/units/qual}{deg}
...
\item For \code{@TimePoint}:
  ...
  calendar seconds \refqualclass{checker/units/qual/time/instant}{CALs},

  calendar nanoseconds \refqualclass{checker/units/qual/time/instant}{CALns},

  calendar microseconds \refqualclass{checker/units/qual/time/instant}{CALus},

  calendar milliseconds \refqualclass{checker/units/qual/time/instant}{CALms},

  calendar minutes \refqualclass{checker/units/qual/time/instant}{CALmin},

  calendar hours \refqualclass{checker/units/qual/time/instant}{CALh},

  calendar half-days \refqualclass{checker/units/qual/time/instant}{CALhalfday},

  calendar days \refqualclass{checker/units/qual/time/instant}{CALday},

  calendar weeks \refqualclass{checker/units/qual/time/instant}{CALweek},

  calendar months \refqualclass{checker/units/qual/time/instant}{CALmonth},

  calendar quarter-years \refqualclass{checker/units/qual/time/instant}{CALquarteryear},

  calendar years \refqualclass{checker/units/qual/time/instant}{CALyear},

  calendar decades \refqualclass{checker/units/qual/time/instant}{CALdecade},

  calendar centuries \refqualclass{checker/units/qual/time/instant}{CALcentury},

  calendar millennia \refqualclass{checker/units/qual/time/instant}{CALmillennia},

  calendar era \refqualclass{checker/units/qual/time/instant}{CALera},

  as well as an artificially defined conceptual unit of
  calendar forever \refqualclass{checker/units/qual/time/instant}{CALforever}
