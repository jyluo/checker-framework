...
public class UnitsRelationsTools {
    ...
    /**
     * Given an Annotated Type, this method returns the Annotation representing the unit that this
     * Annotated Type has.
     *
     * @param annoType an Annotated Type
     * @return an AnnotationMirror representing the unit that this Annotated Type has
     */
     ...
     *     by calling env.getElementUtils() in init() of a Units Relations implementation
     * @param annoType An AnnotatedTypeMirror representing a Units Annotated Type
     * @return A copy of the Annotated Type without the prefix, or null if it cannot be copied
     */
    ...
    /**
     * Checks to see if the two Annotated Types passed in are the exact same units
     *
    ...
    /**
     * Checks to see if the two Annotated Types passed in are the exact same base units
     *
     * @param t1 first annotated type
     * @param t2 second annotated type
     * @return true if they have the same unit, false otherwise
    ...
    /**
     * Checks to see if the two annotation mirrors passed in are the exact same units
     *
    ...
    /**
     * Checks to see if the two annotation mirrors passed in are the exact same base units
     *
     * @param m1 first annotation mirror
     * @param m2 second annotation mirror
     * @return true if they have the same unit, false otherwise
    ...
    /**
     * Given an Annotated Type with a time instant unit, this method returns the Annotation
     * representing the time duration unit that this Annotated Type is related to via {@link
     * DurationUnit}. For any other Annotated Type, this method returns null.
     *
     * @param atf Units Annotated Type Factory
     * @param annoType an Annotated Type with a time instant unit
     * @return an AnnotationMirror representing the time duration unit that this Annotated Type is
     *     related to, or null
     */
     ...
     * TimeInstant}
     *
     * <p>Specifically, it checks to see if the {@link DurationUnit} meta-annotation is present, and
     * that it is a direct subtype of {@link TimeInstant} through the {@link SubtypeOf}
     * meta-annotation. Every time instant unit must be defined with both of these meta-annotations.
     *
