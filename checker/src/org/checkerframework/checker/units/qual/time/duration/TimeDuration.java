...
/**
 * Units of time duration. A time duration represents the duration of a single event or the interval
 * between two events, or more formally a length in a time scale between two time instants.
 *
