...
/**
 * This class handles the methods defined in {@link Number} and its subclasses that behave like
 * arithmetic and comparison operations
 *
 * @author jeff luo
 */
public class UnitsBoxedNumbersClassRelations extends UnitsClassRelations {
    protected UnitsBoxedNumbersClassRelations(
    ...
    public void processMethodInvocation(
        ...
        switch (methodName) {
            ...
            case "compareTo":
                ...
                mathOpRelations.processMathOperation(
                        node, Tree.Kind.EQUAL_TO, resultType, receiverType, argumentType);
                break;
            case "compare":
            case "compareUnsigned":
                ...
                processMathLibraryArithmeticOperation(
                        node, Tree.Kind.EQUAL_TO, resultType, methodArguments);
                break;
            case "divideUnsigned":
                // for Integer and Long
                processMathLibraryArithmeticOperation(
